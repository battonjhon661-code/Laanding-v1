...
const CATALOG: Record<Tab, Item[]> = {
  ЗЕРКАЛА: [
    { name: "Обычное",            preview: `${M}1_Common_Mirror.png`,               video: `${M}1_Common_Mirror.mp4` },
    { name: "Прозрачное",         preview: `${M}2_Clear_Mirror.png`,                video: `${M}2_Clear_Mirror.mp4` },
    { name: "Радужное",           preview: `${M}3_Rainbow_Mirror.png`,              video: `${M}3_Rainbow_Mirror.mp4` },
    { name: "Бронзовое",          preview: `${M}4_Bronze_Tinted_Mirror.png`,        video: `${M}4_Bronze_Tinted_Mirror.mp4` },
    { name: "Серое",              preview: `${M}5_Grey_Tinted_Mirror.png`,          video: `${M}5_Grey_Tinted_Mirror.mp4` },
    { name: "Серо-голубое",       preview: `${M}6_Grey_Blue_Tinted_Mirror.png`,     video: `${M}6_Grey_Blue_Tinted_Mirror.mp4` },
    { name: "Тёмно-золотое",      preview: `${M}7_Dark_Gold_Tinted_Mirror.png` },
    { name: "Розовое",            preview: `${M}8_Pink_Tinted_Mirror.png` },
    { name: "Матовое",            preview: `${M}9_Matte_Mirror.png` },
    { name: "Красное",            preview: `${M}10_Red_Mirror.png` },
    { name: "Светло-золотое",     preview: `${M}11_Light_Gold_Tinted_Mirror.png` },
    { name: "Антик A1",           preview: `${M}12_Antique_Mirror_A1.png` },
    { name: "Антик A2",           preview: `${M}13_Antique_Mirror_A2.png` },
    { name: "Антик A5",           preview: `${M}14_Antique_Mirror_A5.png` },
    { name: "Антик B1",           preview: `${M}15_Antique_Mirror_B1.png` },
    { name: "Антик B2",           preview: `${M}16_Antique_Mirror_B2.png` },
    { name: "Антик C9",           preview: `${M}17_Antique_Mirror_C9.png` },
    { name: "Антик F020-2",       preview: `${M}18_Antique_Mirror_F020_2.png` },
    { name: "Антик F020-9",       preview: `${M}19_Antique_Mirror_F020_9.png` },
    { name: "Антик F021",         preview: `${M}20_Antique_Mirror_F021_Colorless.png` },
    { name: "Антик F030-3",       preview: `${M}21_Antique_Mirror_F030_3.png` },
    { name: "Антик F030-4",       preview: `${M}22_Antique_Mirror_F030_4.png` },
    { name: "Антик F30",          preview: `${M}23_Antique_Mirror_F30.png` },
    { name: "Антик Illaria",      preview: `${M}24_Antique_Mirror_Illaria.png` },
    { name: "Антик J019B",        preview: `${M}25_Antique_Mirror_J019B.png` },
    { name: "Антик J021B",        preview: `${M}26_Antique_Mirror_J021B.png` },
    { name: "Антик J031",         preview: `${M}27_Antique_Mirror_J031.png` },
    { name: "Антик J001",         preview: `${M}28_Antique_Mirror_J001.png` },
    { name: "Антик J002",         preview: `${M}29_Antique_Mirror_J002.png` },
    { name: "Антик J021 5mm",     preview: `${M}30_Antique_Mirror_J021_5mm.png` },
    { name: "Антик J033-5",       preview: `${M}31_Antique_Mirror_J033_5.png` },
    { name: "Антик K1",           preview: `${M}32_Antique_Mirror_K1.png` },
    { name: "Антик K2 Евробронза",preview: `${M}33_Antique_Mirror_K2_Euro_Bronze.png` },
    { name: "Антик K2 Золото-бронза", preview: `${M}34_Antique_Mirror_K2_Gold_Bronze.png` },
    { name: "Антик K2 Золото",    preview: `${M}35_Antique_Mirror_K2_Gold.png` },
    { name: "Антик K2",           preview: `${M}36_Antique_Mirror_K2.png` },
    { name: "Антик K7",           preview: `${M}37_Antique_Mirror_K7.png` },
    { name: "Антик K8",           preview: `${M}38_Antique_Mirror_K8.png` },
    { name: "Антик K12",          preview: `${M}39_Antique_Mirror_K12.png` },
    { name: "Антик K13",          preview: `${M}40_Antique_Mirror_K13.png` },
    { name: "Антик Y7",           preview: `${M}41_Antique_Mirror_Y7.png` },
  ],
  СТЕКЛА: [
    { name: "Обычное",              preview: `${G}1_Common_Glass.png`,                         video: `${G}1_Common_Glass.mp4` },
    { name: "Прозрачное",           preview: `${G}2_Clear_Glass.png`,                          video: `${G}2_Clear_Glass.mp4` },
    { name: "Серое",                preview: `${G}3_Grey_Tinted_Glass.png`,                    video: `${G}3_Grey_Tinted_Glass.mp4` },
    { name: "Тёмно-серое",          preview: `${G}4_Dark_Grey_Tinted_Glass.png`,               video: `${G}4_Dark_Grey_Tinted_Glass.mp4` },
    { name: "Бронзовое",            preview: `${G}5_Bronze_Tinted_Glass.png`,                  video: `${G}5_Bronze_Tinted_Glass.mp4` },
    { name: "Чёрное",               preview: `${G}6_Black_Tinted_Glass.png`,                   video: `${G}6_Black_Tinted_Glass.mp4` },
    { name: "Матовое",              preview: `${G}7_Matte_Common_Glass.png`,                   video: `${G}7_Matte_Common_Glass.mp4` },
    { name: "Матовое прозрачное",   preview: `${G}8_Matte_Clear_Glass.png`,                    video: `${G}8_Matte_Clear_Glass.mp4` },
    { name: "Рифлёное",             preview: `${G}9_Common_Moru_Ribbed_Glass.png`,             video: `${G}9_Common_Moru_Ribbed_Glass.mp4` },
    { name: "Рифлёное прозрачное",  preview: `${G}10_Clear_Moru_Ribbed_Glass.png`,             video: `${G}10_Clear_Moru_Ribbed_Glass.mp4` },
    { name: "Рифлёное бронза",      preview: `${G}11_Bronze_Moru_Ribbed_Glass.png`,            video: `${G}11_Bronze_Moru_Ribbed_Glass.mp4` },
    { name: "Рифлёное серое",       preview: `${G}12_Grey_Moru_Ribbed_Glass.png`,              video: `${G}12_Grey_Moru_Ribbed_Glass.mp4` },
    { name: "Дихроик Аврора",       preview: `${G}13_Dichroic_Glass_Aurora_Green_Orange.png`,  video: `${G}13_Dichroic_Glass_Aurora_Green_Orange.mp4` },
    { name: "Дихроик Роза-синий",   preview: `${G}14_Dichroic_Glass_Rose_Blue.png`,            video: `${G}14_Dichroic_Glass_Rose_Blue.mp4` },
    { name: "Дихроик Золото-фиолет",preview: `${G}15_Dichroic_Glass_Gold_Cyan_Violet.png`,    video: `${G}15_Dichroic_Glass_Gold_Cyan_Violet.mp4` },
    { name: "Master Lane",          preview: `${G}16_Master_Lane_Common.png`,                  video: `${G}16_Master_Lane_Common.mp4` },
    { name: "Vision Sun",           preview: `${G}17_Vision_Sun_Common.png`,                   video: `${G}17_Vision_Sun_Common.mp4` },
    { name: "Estriado",             preview: `${G}18_Estriado_Common.png`,                     video: `${G}18_Estriado_Common.mp4` },
    { name: "Рифлёное сатин",       preview: `${G}19_Ribbed_Moru_Satin.png`,                  video: `${G}19_Ribbed_Moru_Satin.mp4` },
    { name: "Master Soft",          preview: `${G}20_Patterned_Master_Soft.png`,               video: `${G}20_Patterned_Master_Soft.mp4` },
    { name: "Stemalit Розовый",     preview: `${G}21_Stemalit_Candy_Pink.png`,                 video: `${G}21_Stemalit_Candy_Pink.mp4` },
    { name: "Stemalit Голубой",     preview: `${G}22_Stemalit_Sky_Blue.png`,                   video: `${G}22_Stemalit_Sky_Blue.mp4` },
    { name: "Stemalit Лайм",        preview: `${G}23_Stemalit_Lime.png`,                       video: `${G}23_Stemalit_Lime.mp4` },
    { name: "Stemalit Оранжевый",   preview: `${G}24_Stemalit_Tangerine.png`,                  video: `${G}24_Stemalit_Tangerine.mp4` },
    { name: "Stemalit Фиолет",      preview: `${G}25_Stemalit_Purple.png`,                     video: `${G}25_Stemalit_Purple.mp4` },
    { name: "Волновое",             preview: `${G}26_Wave_Glass.png`,                          video: `${G}26_Wave_Glass.mp4` },
  ],
  ТРИПЛЕКС: [
    ...
    <section style={{ position: "relative", zIndex: 0, background: "#0a0b0a", overflow: "hidden", paddingBottom: 32, marginTop: -24, paddingTop: 24 }}>
      ...
      <div style={{ padding: "60px 20px 0", position: "relative", zIndex: 1, textAlign: "center" }}>
        ...
        <p style={{ margin: "12px auto 0", fontFamily: "'Manrope', sans-serif", fontSize: 13, fontWeight: 300, lineHeight: 1.55, color: "rgba(244,241,236,0.52)", maxWidth: "78%" }}>
          Мы тщательно подбираем материалы и комплектующие,<br />чтобы каждая деталь служила долго и выглядела безупречно.
        </p>
      </div>
